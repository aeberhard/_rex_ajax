 ...
 */
	...
	$_ajaxdir = $rxa[$myself]['ajaxdir'] . 'backend/';
...
<div class="rex-addon-output">
  <h2 class="rex-hl2"><?php echo $rxa[$myself]['i18n']->msg('title_backend'); ?></h2>
...
<?php 
	...
	if (file_exists($_ajaxdir . 'backendtest.inc.php'))
	{
	...
	echo $rxa[$myself]['i18n']->msg('beispiel_backend', $_host);
...
<?php
	$_func_add = 'page='.$myself.'&amp;subpage=backend&amp;func=add';
	$_func_edit = 'page='.$myself.'&amp;subpage=backend&amp;func=edit&amp;modul=';
	$_func_del = 'page='.$myself.'&amp;subpage=backend&amp;func=delete&amp;modul=';
?>
<div class="rex-addon-output-v2">

  <table summary="<?php echo $rxa[$myself]['i18n']->msg('editform_summary_be'); ?>" class="rex-table">
    <caption><?php echo $rxa[$myself]['i18n']->msg('editform_caption_be'); ?></caption>
    <colgroup>
      <col width="40" />
      <col width="0" />
      <col width="*" />
